        ...
        if targeted:
            ...
            if random_and_least_likely:
                ...
                if target_classes is None:
                    ...
                    print("")
                    print("shape")
                    print(data.test_data[start+i].shape)
                    print("shape")
                    print(np.array([data.test_data[start+i]]).shape)
                    print("shape")
                    print(predictor(np.array([data.test_data[start+i]])).shape)
                    print(np.squeeze(predictor(np.array([data.test_data[start+i]]))))
